...
@section('container')
    ...
    <div class="flex justify-center items-center pt-2 pb-32">
        <div class="w-80 lg:w-96 p-6 bg-[#FFA658] rounded-md">
            <div class="flex justify-center items-center">
                <a href="/"><img class="w-40 hover:scale-105 duration-300 mb-3" src="/assets/icon.png" alt=""
                        srcset=""></a>
            </div>
            ...
            <form action="/" method="POST">
                ...
                <div class="mt-3">
                    <input name="password" type="password" autocomplete="current-password" required
                        class="bg-gray-100 focus:bg-opacity-60 w-full text-sm px-4 py-3.5 rounded-md outline-gray-800"
                        @error('password') border-red-500 @enderror required" value="{{ old('password') }}"
                ...
                <div class="mt-2 flex justify-between items-center gap-8">
                    <div>
                        <p class="text-xs font-semibold">Belum punya akun?
                            <a href="/register" class="text-blue-600 text-xs font-semibold hover:underline">
                                Registrasi sekarang
                            </a>
                        </p>
                    </div>
                    <div class="text-sm text-right">
                        <a href="/ganti-password" class="text-blue-600 text-xs font-semibold hover:underline">
                            Kamu lupa password?
                        </a>
                    </div>
                </div>
