        ...
        <div class="flex justify-center items-center py-28">
            <div class="flex justify-center items-center w-10/12">
                <div class="w-full p-6 shadow-md bg-green-100 rounded-md">
                    ...
                    <form action="{{ route('storeLiteracy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <select id="subbab" name="subbab"
                                class="bg-white focus:bg-opacity-60 w-full text-base px-4 py-3.5 rounded-md outline-gray-800">
                                <option value="Digital Mindset">Digital Mindset</option>
                                <option value="Literasi Digital">Literasi Digital</option>
                                <option value="Kecakapan Digital">Kecakapan Digital</option>
                                <option value="Lanskap Digital">Lanskap Digital</option>
                                <option value="Mesin Pencari Informasi">Mesin Pencari Informasi</option>
                                <option value="Cakap Bermedia Digital">Cakap Bermedia Digital</option>
                            </select>
                            @error('category')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
