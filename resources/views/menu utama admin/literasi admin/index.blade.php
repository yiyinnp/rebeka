                ...
                <table class="table-auto border-collapse w-full rounded-md">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white divide-y divide-gray-400">
                            ...
                            <td class="py-1">{{ $literacy->title }}</td>
                            <td class="py-1">{{ $literacy->subbab }}</td>
                            <td class="py-1">{{ $literacy->category }}</td>
                            <td class="text-center py-1">
                                <div class="flex justify-center space-x-2">
                                    <!-- Tombol View -->
                                    <a href="{{ route('showLiteracy', $literacy->id) }}">
                                    ...
                                    <!-- Tombol Edit -->
                                    <form action="{{ route('editLiteracy', $literacy->id) }}" method="GET">
                                        @csrf
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('deleteLiteracy', $literacy->id) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
