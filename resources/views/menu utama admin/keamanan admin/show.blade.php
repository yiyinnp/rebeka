...
@section('container')
    <div class="main-content lg:ml-[250px] transition-all duration-300 ease-in-out">
        ...
        <div class="px-10 pt-3 pb-10">
            <div class="w-full">
                <h3 class="py-1"><b>Subbab pembahasan:</b> {{ $security->subbab }}</h3>
                <h3 class="py-1"><b>Kategori:</b> {{ $security->category }}</h3>
                ...
                <div class="flex justify-center space-x-4 mt-6">
                    <a href="{{ route('editSecurity', $security->id) }}">
