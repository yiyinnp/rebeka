                ...
                <table class="table-auto border-collapse w-full rounded-md">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white divide-y divide-gray-400">
                            ...
                            <td class="py-1">{{ $evaluation->title }}</td>
                            <td class="text-center py-1">
                                <div class="flex justify-center space-x-2">
                                    <!-- Tombol View -->
                                    <a href="{{ route('showEvaluation', $evaluation->id) }}">
                                    ...
                                    <!-- Tombol Edit -->
                                    <form action="{{ route('editEvaluation', $evaluation->id) }}" method="GET">
                                        @csrf
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('deleteEvaluation', $evaluation->id) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
